...
static int cs47l90_slim_tx1_ev(struct snd_soc_dapm_widget *w,
			       struct snd_kcontrol *kcontrol, int event)
{
	return madera_slim_tx_ev(w, kcontrol, event, 5);
}

static int cs47l90_slim_tx2_ev(struct snd_soc_dapm_widget *w,
			       struct snd_kcontrol *kcontrol, int event)
{
	return madera_slim_tx_ev(w, kcontrol, event, 6);
}

static int cs47l90_slim_tx3_ev(struct snd_soc_dapm_widget *w,
			       struct snd_kcontrol *kcontrol, int event)
{
	return madera_slim_tx_ev(w, kcontrol, event, 7);
}

static int cs47l90_slim_rx1_ev(struct snd_soc_dapm_widget *w,
			       struct snd_kcontrol *kcontrol, int event)
{
	return madera_slim_rx_ev(w, kcontrol, event, 5);
}

static int cs47l90_slim_rx2_ev(struct snd_soc_dapm_widget *w,
			       struct snd_kcontrol *kcontrol, int event)
{
	return madera_slim_rx_ev(w, kcontrol, event, 6);
}

static int cs47l90_slim_rx3_ev(struct snd_soc_dapm_widget *w,
			       struct snd_kcontrol *kcontrol, int event)
{
	return madera_slim_rx_ev(w, kcontrol, event, 7);
}
...
SND_SOC_DAPM_AIF_OUT_E("SLIMTX1", NULL, 0, MADERA_SLIMBUS_TX_CHANNEL_ENABLE,
		     MADERA_SLIMTX1_ENA_SHIFT, 0, cs47l90_slim_tx1_ev,
		     SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_OUT_E("SLIMTX2", NULL, 0, MADERA_SLIMBUS_TX_CHANNEL_ENABLE,
		     MADERA_SLIMTX2_ENA_SHIFT, 0, cs47l90_slim_tx1_ev,
		     SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_OUT_E("SLIMTX3", NULL, 0, MADERA_SLIMBUS_TX_CHANNEL_ENABLE,
		     MADERA_SLIMTX3_ENA_SHIFT, 0, cs47l90_slim_tx1_ev,
		     SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_OUT_E("SLIMTX4", NULL, 0, MADERA_SLIMBUS_TX_CHANNEL_ENABLE,
		     MADERA_SLIMTX4_ENA_SHIFT, 0, cs47l90_slim_tx1_ev,
		     SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_OUT_E("SLIMTX5", NULL, 0, MADERA_SLIMBUS_TX_CHANNEL_ENABLE,
		     MADERA_SLIMTX5_ENA_SHIFT, 0, cs47l90_slim_tx2_ev,
		     SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_OUT_E("SLIMTX6", NULL, 0, MADERA_SLIMBUS_TX_CHANNEL_ENABLE,
		     MADERA_SLIMTX6_ENA_SHIFT, 0, cs47l90_slim_tx2_ev,
		     SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_OUT_E("SLIMTX7", NULL, 0, MADERA_SLIMBUS_TX_CHANNEL_ENABLE,
		     MADERA_SLIMTX7_ENA_SHIFT, 0, cs47l90_slim_tx3_ev,
		     SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_OUT_E("SLIMTX8", NULL, 0, MADERA_SLIMBUS_TX_CHANNEL_ENABLE,
		     MADERA_SLIMTX8_ENA_SHIFT, 0, cs47l90_slim_tx3_ev,
		     SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
...
SND_SOC_DAPM_AIF_IN_E("SLIMRX1", NULL, 0, MADERA_SLIMBUS_RX_CHANNEL_ENABLE,
		      MADERA_SLIMRX1_ENA_SHIFT, 0, cs47l90_slim_rx1_ev,
		      SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_IN_E("SLIMRX2", NULL, 0, MADERA_SLIMBUS_RX_CHANNEL_ENABLE,
		      MADERA_SLIMRX2_ENA_SHIFT, 0, cs47l90_slim_rx1_ev,
		      SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_IN_E("SLIMRX3", NULL, 0, MADERA_SLIMBUS_RX_CHANNEL_ENABLE,
		      MADERA_SLIMRX3_ENA_SHIFT, 0, cs47l90_slim_rx1_ev,
		      SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_IN_E("SLIMRX4", NULL, 0, MADERA_SLIMBUS_RX_CHANNEL_ENABLE,
		      MADERA_SLIMRX4_ENA_SHIFT, 0, cs47l90_slim_rx1_ev,
		      SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_IN_E("SLIMRX5", NULL, 0, MADERA_SLIMBUS_RX_CHANNEL_ENABLE,
		      MADERA_SLIMRX5_ENA_SHIFT, 0, cs47l90_slim_rx2_ev,
		      SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_IN_E("SLIMRX6", NULL, 0, MADERA_SLIMBUS_RX_CHANNEL_ENABLE,
		      MADERA_SLIMRX6_ENA_SHIFT, 0, cs47l90_slim_rx2_ev,
		      SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_IN_E("SLIMRX7", NULL, 0, MADERA_SLIMBUS_RX_CHANNEL_ENABLE,
		      MADERA_SLIMRX7_ENA_SHIFT, 0, cs47l90_slim_rx3_ev,
		      SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_IN_E("SLIMRX8", NULL, 0, MADERA_SLIMBUS_RX_CHANNEL_ENABLE,
		      MADERA_SLIMRX8_ENA_SHIFT, 0, cs47l90_slim_rx3_ev,
		      SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
