...
static int cs47l92_slim_tx1_ev(struct snd_soc_dapm_widget *w,
			       struct snd_kcontrol *kcontrol, int event)
{
	return madera_slim_tx_ev(w, kcontrol, event, 5);
}

static int cs47l92_slim_tx2_ev(struct snd_soc_dapm_widget *w,
			       struct snd_kcontrol *kcontrol, int event)
{
	return madera_slim_tx_ev(w, kcontrol, event, 6);
}

static int cs47l92_slim_tx3_ev(struct snd_soc_dapm_widget *w,
			       struct snd_kcontrol *kcontrol, int event)
{
	return madera_slim_tx_ev(w, kcontrol, event, 7);
}

static int cs47l92_slim_rx1_ev(struct snd_soc_dapm_widget *w,
			       struct snd_kcontrol *kcontrol, int event)
{
	return madera_slim_rx_ev(w, kcontrol, event, 5);
}

static int cs47l92_slim_rx2_ev(struct snd_soc_dapm_widget *w,
			       struct snd_kcontrol *kcontrol, int event)
{
	return madera_slim_rx_ev(w, kcontrol, event, 6);
}

static int cs47l92_slim_rx3_ev(struct snd_soc_dapm_widget *w,
			       struct snd_kcontrol *kcontrol, int event)
{
